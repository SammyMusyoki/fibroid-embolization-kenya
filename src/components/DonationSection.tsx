            ...
            <HeroComponent className='bg-hero2'>
                <div className="text-start relative">
                    ...
                    <p className='font-medium lg:text-2xl text-xl my-5 text-gray-900'>
                        With your help, We can make a difference in thousands of women lives. <Link href="make-a-donation" className='text-pink-600 hover:underline'>Donate</Link> today!
                    </p>
                </div>
            </HeroComponent>
    </React.Fragment>
